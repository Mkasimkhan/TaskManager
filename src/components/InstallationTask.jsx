...
//   const filteredInstallationTasks = filterTasks({
//     tasks,
//     startDate,
//     endDate,
//     statusFilter,
...
//   const total = filteredInstallationTasks.length;
//   const pending = filteredInstallationTasks.filter(task => task.status === "Pending").length;
//   const completed = filteredInstallationTasks.filter(task => task.status === "Completed").length;

//   return (
//     <div className="mx-auto px-4">
//       <TaskStats total={total} pending={pending} completed={completed} />

//       {filteredInstallationTasks.length > 0 ? (
//         <>
//           <div className="flex justify-between items-center mt-4 mb-2">
//             <h2 className="text-xl font-semibold">Installation Tasks</h2>
//             <button
...
//                 }}
//               >
//                 {filteredInstallationTasks.map((task) => (
//                   <TaskCard
//                     key={task.firebaseId}
//                     id={task.firebaseId}
//                     title={task.title}
...
const InstallationTask = () => {
  return <FilteredTasksTable taskType="Installation" title="All Tasks" />;
};
